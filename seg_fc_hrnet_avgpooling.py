...
from tensorflow.keras.layers import UpSampling2D, add, concatenate, Dropout, AveragePooling2D
...
def seg_fc_hrnet(height=256, width=256, channel=3, classes=2):
...
# model = seg_fc_hrnet(height=256, width=256, channel=3, classes=3)
# model.summary()
if __name__ == '__main__':
    model = seg_fc_hrnet()
    model.summary()
    # __________________________________________________________________________________________________
    # conv2d_175(Conv2D)(None, 256, 256, 2)
    # 64
    # add_40[0][0]
    # __________________________________________________________________________________________________
    # batch_normalization_175(BatchN(None, 256, 256, 2)
    # 8
    # conv2d_175[0][0]
    # __________________________________________________________________________________________________
    # Classification(Activation)(None, 256, 256, 2)
    # 0
    # batch_normalization_175[0][0]
    # __________________________________________________________________________________________________
    # reshape(Reshape)(None, 65536, 2)
    # 0
    # Classification[0][0]
    # == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == ==