...
def train():
    ...
    # 保存H
    with open('训练记录/TrainHistory-Seg_resnet50_unet-1_label-50_epoch.data', 'wb') as file_pi:
        pickle.dump(H.history, file_pi)

    # 保存模型方法1
    model_save_path = r"训练权重/seg_resnet50_unet-model_50_only_1.h5"
    ...
    plt.show()
    plt.savefig("result_resnet50_unet.png")
