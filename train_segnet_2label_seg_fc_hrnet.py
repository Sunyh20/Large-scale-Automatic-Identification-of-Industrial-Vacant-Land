...
def train():
    ...
    # 保存H
    with open('训练记录/TrainHistory-Seg_fc_hrnet-1_label-50_epoch.data', 'wb') as file_pi:
        pickle.dump(H.history, file_pi)

    #保存模型方法1
    model_save_path = r"训练权重/aaa_seg_fc_hrnet_avgpooling-model_50_only_1.h5"
